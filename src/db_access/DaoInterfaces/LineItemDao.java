...
public interface LineItemDao {
	...
	ArrayList<LineItem> findLineItemsByOrder(Order order, boolean retrieveProduct) throws SQLException, Exception ;
	ArrayList<LineItem> findLineItemsByProduct(Product product, boolean retrieveOrder) throws SQLException, Exception;
	ArrayList<LineItem> findAllLineItems(boolean retrieveOrder, boolean retrieveProduct) throws SQLException, Exception;
